 ...
 * Extracted to adhere to the Single Responsibility Principle (SRP) by separating
 * the decision of where to log from how to format and log the message.
 *
 * @param {Error|string} error - The error object or message string to report.
 * @param {Object} context - Additional metadata to append to the error context.
 */
